...
namespace Microsoft.WindowsAzure.MobileServices.Test
{
    ...
    public class MobileServiceSyncContextTests : TestBase
    {
        ...
        public async Task PushAsync_ExecutesThePendingOperations_InOrder()
        {
            ...
            service = new MobileServiceClient(MobileAppUriValidator.DefaultMobileApp, "secret...", hijack);
            await service.SyncContext.InitializeAsync(store, new MobileServiceSyncHandler());
        ...
        {
            var client = new MobileServiceClient(MobileAppUriValidator.DefaultMobileApp);
            var store = new MobileServiceLocalStoreMock();
