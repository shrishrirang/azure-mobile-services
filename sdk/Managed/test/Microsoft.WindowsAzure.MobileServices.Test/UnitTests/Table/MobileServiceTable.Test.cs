    ...
    public class MobileServiceTableTests : TestBase
    {
        ...
        public async Task ReadAsyncWithStringIdFilter()
        {
            ...
            foreach (string testId in testIdData)
            {
                ...
                Uri expectedUri = new Uri(string.Format(urlTestHelper.GetTableUri("someTable?$filter=id eq '{0}'"), idForOdataQuery));
        ...
        public async Task ReadAsyncWithNullIdFilter()
        {
            ...
            Uri expectedUri = new Uri(urlTestHelper.GetTableUri("someTable?$filter=id eq null"));
        ...
        public async Task LookupAsyncWithStringIdParameter()
        {
            ...
            foreach (string testId in testIdData)
            {
                ...
                Uri expectedUri = new Uri(string.Format(urlTestHelper.GetTableUri("someTable/{0}"), Uri.EscapeDataString(testId)));
        ...
        public async Task LookupAsyncWithIntIdParameter()
        {
            ...
            foreach (long testId in testIdData)
            {
                ...
                Uri expectedUri = new Uri(string.Format(urlTestHelper.GetTableUri("someTable/{0}"), testId));
